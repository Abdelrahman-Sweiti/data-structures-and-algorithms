...
namespace CodeChallenge38
{
    public class Graph
    {
        ...
        public Stack<Vertex> DepthFirst(Graph graph)
        {
        ...
        public Stack<Vertex> DepthFirstHelper(Graph graph, Stack<Vertex> stack, Vertex root)
        {
            root.Visited = true;
            stack.Push(root);
